...
process a *container's* filesystem view by joining its mount namespace and nothing else. 0089
and 0090 point it inward, so a third-party MCP image can serve the primary container's real
