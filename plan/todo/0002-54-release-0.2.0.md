...
- **0002-52's recorded soak parameters are satisfied** -- the window, the qualifying use, the
  evidence source, and the blocker policy, all decided in 0002-52 before rc.3 shipped. This task
  checks that record; it does not write it. An RC nobody installed has not been
  integration-tested, however many days elapsed.
- **No open defect of the class 0002-52's record calls blocking.**
...
- **Final package validation**, re-run rather than assumed to still hold: 0002-48's snapshot gate,
  0002-52's version guard, 0002-52's install-shaped check, and the combined
