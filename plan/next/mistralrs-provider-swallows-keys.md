...
Found while writing the `request-timeout-secs` range check (0002-29). That task
...
0002-34 raised the stakes and corrected the record. Removing
...
Measured while landing 0002-34, `retry-budget-secs`, `request-timeout-secs`,
