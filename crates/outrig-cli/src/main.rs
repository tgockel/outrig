...
use outrig_cli::cli::design_prompt::{self, DesignArgs};
use outrig_cli::cli::discard::{self, DiscardArgs};
use outrig_cli::cli::logs::{self, LogsArgs};
use outrig_cli::cli::ls::{self, LsArgs};
use outrig_cli::cli::mcp::{self, McpArgs};
use outrig_cli::cli::mcp_self as mcp_self_cli;
use outrig_cli::cli::run::{self, RunArgs};
use outrig_cli::error::Result;
use outrig_cli::{config_init, container_setup, init};
